...
internal object HomeIcons {
    ...
    /**
     * Material Symbol: cloud_off (24 dp, filled).
     * Used as the icon in the empty-state prompt card on the Home screen.
     */
    val CloudOff: ImageVector by lazy {
        ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(-1.48f, 0f, -2.85f, 0.43f, -4.0f, 1.17f)
                ...
                curveTo(23.14f, 18.16f, 24f, 16.68f, 24f, 15f)
                ...
                curveToRelative(0f, -2.16f, 1.72f, -3.93f, 3.73f, -3.99f)
                close()
            }
        }.build()
    }
